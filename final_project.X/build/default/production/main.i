...
int tmr_cnt = 0;
int Xmas[49] = {
    126,126,126,126,126,126,126,105,158,141,126,
    119,119,119,119,119,126,126,126,126,141,141,126,141,105,
    126,126,126,126,126,126,126,105,158,141,126,
    119,119,119,119,119,126,126,126,105,105,119,141,158
};
int waitXmas[49] = {
...
int bee[50] = {
    141,
    105,126,126,119,141,141,158,141,126,119,105,105,105,
    105,126,126,119,141,141,158,126,105,105,126,
    141,141,141,141,141,126,119,
    126,126,126,126,126,119,105,
    105,126,126,119,141,141,158,126,105,105,158
};
int waitBee[50] = {
...
void showPace(int i) {
    ...
    char seg[]=
    {
       ...
       displayWord(seg[g]);
        RC3=1;
        _delay((unsigned long)((0.2)*(4000000/4000.0)));
        RC3=0;
         displayWord(seg[e]);
        RC2=1;
        _delay((unsigned long)((0.2)*(4000000/4000.0)));
