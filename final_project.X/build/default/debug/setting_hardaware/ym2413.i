...
# 2 "<built-in>" 2
# 1 "setting_hardaware/ym2413.c" 2
# 1 "setting_hardaware/ym2413.h" 1
# 19 "setting_hardaware/ym2413.h"
...
# 19 "setting_hardaware/ym2413.h" 2
...
extern volatile __bit LATD6 __attribute__((address(0x7C22)));
...
# 2 "setting_hardaware/ym2413.c" 2
...
void YM2413Write(int address, int data){
    ...
    LATD6 = 1;
    LATB2 = 0;
    LATA0 = get_bits(0, address);
    LATA1 = get_bits(1, address);
    LATA2 = get_bits(2, address);
    LATA3 = get_bits(3, address);
    LATB4 = get_bits(4, address);
    LATE0 = get_bits(5, address);
    LATE1 = get_bits(6, address);
    LATB3 = get_bits(7, address);
    LATD6 = 0;

    _delay((unsigned long)((3.5)*(4000000/4000000.0)));
    LATD6 = 1;

    LATD6 = 1;
    LATB2 = 1;
    LATA0 = get_bits(0, data);
    LATA1 = get_bits(1, data);
    LATA2 = get_bits(2, data);
    LATA3 = get_bits(3, data);
    LATB4 = get_bits(4, data);
    LATE0 = get_bits(5, data);
    LATE1 = get_bits(6, data);
    LATB3 = get_bits(7, data);
    LATD6 = 0;
...
void canon(int base_instrument, int main_instrument, float bpm) {
    ...
    stopNote(2, 1);
    stopNote(3, 1);
# 891 "setting_hardaware/ym2413.c"
}
